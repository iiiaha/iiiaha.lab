  ...
  return (
    <footer>
      ...
      <div className="max-w-[800px] mx-auto px-10 max-sm:px-5 py-8">
        <div className="flex justify-between text-[13px] mb-6 max-sm:flex-col max-sm:gap-2">
          <div className="flex flex-col gap-1">
            <span className="font-bold tracking-[0.05em]">iiiaha.lab</span>
            <span className="text-[#999]">contact@iiiahalab.com</span>
          </div>
        </div>
        <div className="flex justify-between gap-6 text-[11px] text-[#999] leading-[1.8] max-sm:flex-col max-sm:gap-3">
          ...
          <div className="flex flex-col gap-0.5 shrink-0 text-right max-sm:text-left">
            ...
            <Link href="/terms" className="text-[#666] hover:text-[#111]">
              Terms
            </Link>
            <Link href="/privacy" className="text-[#666] hover:text-[#111]">
              Privacy
            </Link>
          </div>
        </div>
